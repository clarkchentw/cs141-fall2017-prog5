...
//--------------------------------------------------------------------------------
// Initialize board
void initializeBoard(bogglePiece bogglePieceObjectArray[6][6], wordFoundContainer wordFound[MaxWordsFoundOnBoard], bool customBoard=false, const char userInput[ MaxWordLength+1]=new char[ MaxWordLength+1]){
...
void displayBoard1(bogglePiece bogglePieceObjectArray[6][6]){
    for (int y = 1; y < 5; y++)
    {
        for (int x = 1; x < 5; x++)
        {
...
void searchSpot(char **dictionary, bogglePiece bogglePieceObjectArray[6][6], wordFoundContainer wordFound[MaxWordsFoundOnBoard], int spotX, int spotY, char*& buildWord, int*& (buildWordPosHistoryX), int*& (buildWordPosHistoryY), int &buildWordPosHistoryIndex){
    //displaySelectedPoint(bogglePieceObjectArray, spotX, spotY); ////////////////////////////////////////////////////////////////////////////////////////////////////debug
    
//        displayPieceUsage(bogglePieceObjectArray);//////////////////// For debug purpose
...
//    cout << "Y: " << spotY << endl << endl;
    ...
    if (bogglePieceObjectArray[spotX][spotY].getCurrentSearchIndex() >= 8){
        //cout << "getCurrentSearchIndex: " << bogglePieceObjectArray[spotX][spotY].getCurrentSearchIndex() << endl;///////////////////////debug
        return;
    }
    ...
    if (!isalpha(bogglePieceObjectArray[spotX][spotY].getLetter())){
        //cout << "getCurrentSearchIndex: " << bogglePieceObjectArray[spotX][spotY].getLetter() << endl;///////////////////////debug
        return;
    }
    else
    {
        ...
        while (bogglePieceObjectArray[spotX][spotY].getCurrentSearchIndex() < 8){
            //cout << "Debug Passing Info:" << endl << "Search Index:" << bogglePieceObjectArray[spotX][spotY].getCurrentSearchIndex() << endl << bogglePieceObjectArray[spotX][spotY].nextX(true) << ":" << bogglePieceObjectArray[spotX][spotY].nextY(true) << endl << endl << endl;
...
void searchBoard(char **dictionary, bogglePiece bogglePieceObjectArray[6][6], wordFoundContainer wordFound[MaxWordsFoundOnBoard]){
    ...
    //int spotX = 1;
    //int spotY = 1;
    //cout << "Debug Passing Info1:" << endl << "Search Index:" << bogglePieceObjectArray[spotX][spotY].getCurrentSearchIndex() << endl << bogglePieceObjectArray[spotX][spotY].nextX() << ":" << bogglePieceObjectArray[spotX][spotY].nextY() << endl << endl << endl;
    //exit(1);
    ...
    for (int y = 1; y <= 4; y++){
        for (int x = 1; x <= 4; x++){
            //x=1;y=1; ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////Debug
            //cout << "Search Start at x = " << x << " y = " << y << endl;////////////////////////////////////////////////////////////////////////////////////Debug
...
int main()
{
    ...
    //initializeBoard(bogglePieceObjectArray, wordFound, numOfWordFound);
    ...
    //while(true){
	    ...
	    ////////////////////////////////////////////////////////////////////////////////////////
        // Remove duplicate word
        int numOfWordOriginallyFound = wordFoundContainer::numOfWordFound;
	    for (int i = 0; i < wordFoundContainer::numOfWordFound; i++){
		    for (int j = 0; j < wordFoundContainer::numOfWordFound; j++){
		    	if (i != j && strcmp(wordFound[i].getWord(), wordFound[j].getWord()) == 0){
					wordFound[j].resetWord();
        ...
        // show final result
	    for (int i = 0; i < numOfWordOriginallyFound; i++){
	    	if (strlen(wordFound[i].getWord()) > 0){
